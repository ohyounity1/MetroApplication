...
namespace Framework.Data.Serialize.CSV
{
    ...
    public class IncorrectCSVEnumValueFormatting : IncorrectCSVValueFormatting
    {
        ...
        public IncorrectCSVEnumValueFormatting(Type enumType, string propertyName, string value) : base(propertyName, value) => _enumType = enumType;

        /// <summary>
        /// <see cref="object.ToString"/>
        /// </summary>
        /// <returns>Error string</returns>
        public override string ToString() => $"{base.ToString()}, expected enum of type {_enumType.Name}";
    }
}
